$(function() {
    ...
    function g(n) {
        var prevTotalWidth = f($(n).prevAll()),
            nextTotalWidth = f($(n).nextAll());
        ...
        if ($(".page-tabs-content").outerWidth() < k) {
            ...
            if (nextTotalWidth <= (k - $(n).outerWidth(true) - $(n).next().outerWidth(true))) {
                if ((k - $(n).next().outerWidth(true)) > nextTotalWidth) {
                    p = prevTotalWidth;
                    var m = n;
                ...
                if (prevTotalWidth > (k - $(n).outerWidth(true) - $(n).prev().outerWidth(true))) {
                    p = prevTotalWidth - $(n).prev().outerWidth(true)
                }
            }
        }
    ...
    /* 为每个 菜单元素增加 data-index 属性 */
    $(".menuItem").each(function(k) {
    ...
    function menuItemClickHander() {
        ...
        if (neverOpened) {
            var menuTab = '<a href="javascript:;" class="active J_menuTab" data-id="' + hrefAttr + '">' + menuName + ' <i class="fa fa-times-circle"></i></a>';
            $(".J_menuTab").removeClass("active");
            var iframe = '<iframe class="J_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + hrefAttr + '" frameborder="0" data-id="' + hrefAttr + '" seamless></iframe>';
